...
// It should prin, true.
// Write your code below:
console.log("Fido barks: " + fido.barks);
...
// Write your code below:
let spike = new Dog("spike", null, true);

// Print spike wagstrail.
// It should print, true.
// Write your code below:
console.log("spike wagstrail " + spike.wagstail);
...
// Write your code below:
class Math extends SubjectClass {
    constructor(requiresBooks){
      super (requiresBooks)
    this.requireCalculator = true;
  }
}
...
// Write your code below:
let geometry = new Geometry (true, true, true)
...
let trigonometry = new Trigonometry(true, true, true, "TI-83");
